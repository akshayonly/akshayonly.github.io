...
Imagine if you had a fork without its teeth (tine), would you be able to eat? Or a car with Square tires rather than circular. Absurd, but the point here is about the shape which leads to functioning. From macroscale objects to microscale biological molecules, the shape is an important characteristic for their function. When one of the biomolecules (Protein) loses its shape, it either results in loss of some function or havoc which results in Alzheimer's disease[^2]
